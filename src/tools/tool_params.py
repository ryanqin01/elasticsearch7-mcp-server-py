...
class baseToolArgs(BaseModel):
    """Base class for all tool arguments that contains common Elasticsearch connection parameters."""

    elasticsearch_cluster_name: str = Field(
        default='', description='The name of the Elasticsearch cluster'
    )
